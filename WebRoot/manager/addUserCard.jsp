      ...
      <div class="row">
       <jsp:include page="../left.jsp"/>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	      	<form action="UserServlet?method=addUserCard" method="post">
			  <fieldset>
			    <legend>房卡充值</legend>
			    <label>充值数量:</label>
			    <input type="hidden" name="userId" value="${userId }">
			    <input type="number" placeholder="输入房卡的数量:" value="1" name="total">
			    <label class="checkbox">
			    </label>
			    <label>充值金额:</label>
			    <input type="number" placeholder="充值的总金额:" value="1" name="money">
			    <label class="checkbox">
			    </label>
