                  ...
                  <div class="col-lg-6">
                     <section class="panel">
                        <header class="panel-heading">
                           <span class="label label-primary">创建代理消息</span>
                        ...
                        <div class="panel-body">
                           <form class="form-horizontal" role="form" method="post" action="RoomServlet?method=createBuyCardMessage">
                              <div class="form-group">
                                 <label for="address" class="col-lg-2 col-sm-2 control-label">消息:</label>
                                 <div class="col-lg-8">
                                    <textarea rows="5" cols="30" class="form-control" name="message" required="required"></textarea>
                                 </div>
                              </div>
