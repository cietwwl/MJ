                  ...
                  <div class="col-lg-6">
                     <section class="panel">
                        <header class="panel-heading">
                           <span class="label label-primary">修改代理</span>
                        ...
                        <div class="panel-body">
                           <form class="form-horizontal" role="form" method="post" action="UserServlet?method=modifyOperate">
                              <div class="form-group">
                                 <label for="userName" class="col-lg-2 col-sm-2 control-label">代理名称:</label>
                                 <div class="col-lg-8">
                                 	<input type="hidden" value="${operateUser.id }" name="id">
                              ...
                              <div class="form-group">
                                 <label for="mobile" class="col-lg-2 col-sm-2 control-label">密码:</label>
                                 <div class="col-lg-8">
                                    <input type="password" class="form-control" name="password" placeholder="密码" pattern="\S{6,15}"  value="">
                                 </div>
                              </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-lg-8">
                                    <input type="text" class="form-control" name="mobile" placeholder="手机号"  pattern="^1[3-9]\d{9}$" required="required" value="${operateUser.mobile}">
                                 </div>
                              </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-lg-8">
                                    <textarea rows="5" cols="30" class="form-control" name="address" required="required">${operateUser.address }</textarea>
                                 </div>
                              </div>
