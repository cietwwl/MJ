              ...
              <div class="col-lg-3 col-sm-3">
                <div class="pricing-table">
                  ...
                  <ul class="list-unstyled">
                    <li>
        				代理Id:${requestScope.user.id }
                    </li>
                    <li>
        				用户名:${requestScope.user.username }
                    </li>
                    <li>
        				手机号:${requestScope.user.mobile }
                    </li>
                    <li>
        				房卡消耗数:${requestScope.user.consumeCard }
                    </li>
                    <li>
        				我的推荐号:${requestScope.user.recommendId }
                    </li>
                  </ul>
                </div>
              </div>
